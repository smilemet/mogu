          ...
          <section className="content">
            ...
            <div className="text-content">
              <p>
                ...
                산으로 올라서려니까 등 뒤에서 푸드득 푸드득 하고 닭의 횃소 리가 야단이다. 깜짝 놀라서 고개를
                돌려 보니 아니나 다르랴 두 놈이 또 얼리 었다.*
              </p>
              <p>
                점순네 수탉(대강이가 크고 똑 오소리같이 실팍하게* 생긴 놈)이 덩저리 작은 우리 수탉을 함부로
                해내는 것이다. 그것도 그냥 해내는 것이 아니라 푸드득하 고 면두*를 쪼고 물러섰다가 좀 사이를
                두고 푸드득하고 모가지를 쪼았다. 이렇 게 멋을 부려 가며 여지없이 닦아* 놓는다. 그러면 이
                못생긴 것은 쪼일 적마다 주둥이로 땅을 받으며 그 비명이 킥, 킥, 할뿐이다. 물론 미처 아물지도
                않은 면 두를 또 쪼이며 붉은 선혈은 뚝뚝 떨어진다. 이걸 가만히 내려다보자니 내 대강 이가 터져서
                피가 흐르는 것같이 두 눈에서 불이 번쩍 난다. 대뜸 지게막대기를 메고 달려들어 점순네 닭을
          ...
          <section className="FAQ">
            ...
            <div className="text-content">
              <div>
                ...
                <p>
                  A. 판매자가 FAQ 답변을 적어두는 곳이에요. 자주 들어오는 문의사항에 대한 것은 이곳에 적어요.
                </p>
              </div>
              <div>
                <p className="bold">Q. 여기에는 무엇을 적나요?</p>
